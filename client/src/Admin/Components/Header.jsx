...
const Header = (props) => {
  ...
  return (
      <>
      <nav className={`${menushow ? 'lg:pl-[15rem] pl-[0rem]' : 'pl-[5rem]'} max-w-full w-full h-16 z-[100] fixed shadow-[-7.829px_11.607px_20px_#908fa017] transition-all duration-[0.1s] ease-[ease] border-b border-[#e1e6f1] bg-[#fff] px-4`}>
