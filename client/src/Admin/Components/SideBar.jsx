                                ...
                                return (
                                    <>
                                        {menu.cat === 'heading' ? (
                                            ...
                                            (
                                                <li onClick={()=> MenuOpen(menu)} className={menuActive === menu.id ? 'mt-[5px] p-0' : 'my-[5px]'}>
                                                    ...
                                                    {(menu.submenu && subMenuActive && currentMenu === menu.id) &&
                                                        <ul className='pl-[1.2rem]'>
                                                            {menu.submenu.map((submenu, i) => {
                                                                return (
                                                                    <>
                                                                        <li onClick={()=>setMenuActive(menu.id)}>
